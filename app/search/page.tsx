  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      ...
      <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
        Find invoices using natural language instead of exact keywords.
      </p>
      <p className="mt-1 text-xs text-zinc-400 dark:text-zinc-500">
        Search invoices naturally using AI. Results are based on meaning and context, not just keyword matches.
      </p>
